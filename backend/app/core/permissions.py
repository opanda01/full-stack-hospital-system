...
def _mudur_izinleri() -> dict[str, Kapsam]:
    ...
    return {
        ...
        "hasta:guncelle": Kapsam.GLOBAL,
        "muayene:goruntule": Kapsam.GLOBAL,
        "tetkik:goruntule": Kapsam.GLOBAL,
        "radyoloji:goruntule": Kapsam.GLOBAL,
        "radyoloji:iste": Kapsam.GLOBAL,
        "radyoloji:sonuc_gir": Kapsam.GLOBAL,
        ...
        "servis:goruntule": Kapsam.GLOBAL,
        "yatak:goruntule": Kapsam.GLOBAL,
        "yatak:ata": Kapsam.GLOBAL,
        "yatak:durum_guncelle": Kapsam.GLOBAL,
        ...
        "servis:goruntule": Kapsam.GLOBAL,
        "yatak:goruntule": Kapsam.DEPARTMANIM,
        "yatak:ata": Kapsam.DEPARTMANIM,
        ...
        "epikriz:goruntule": Kapsam.GLOBAL,
        "epikriz:olustur": Kapsam.GLOBAL,
        "epikriz:guncelle": Kapsam.GLOBAL,
        "epikriz:onayla": Kapsam.GLOBAL,
        "ameliyat:planla": Kapsam.GLOBAL,
        "ameliyat:goruntule": Kapsam.GLOBAL,
        "ameliyat:guncelle": Kapsam.GLOBAL,
        "ameliyat:iptal_et": Kapsam.GLOBAL,
        "anestezi:kaydet": Kapsam.GLOBAL,
...
IZIN_MATRISI: dict[Rol, dict[str, Kapsam]] = {
    ...
    Rol.DOKTOR: {
        ...
        "hasta:guncelle": Kapsam.KENDI_KAYDIM,
        ...
        "epikriz:olustur": Kapsam.KENDI_KAYDIM,
        "epikriz:guncelle": Kapsam.KENDI_KAYDIM,
        "epikriz:onayla": Kapsam.KENDI_KAYDIM,
        "yatis:goruntule": Kapsam.GLOBAL,
        "yatis:islem": Kapsam.KENDI_KAYDIM,
        "servis:goruntule": Kapsam.GLOBAL,
        "yatak:goruntule": Kapsam.DEPARTMANIM,
        "yatak:ata": Kapsam.DEPARTMANIM,
        "yatak:durum_guncelle": Kapsam.DEPARTMANIM,
        "ameliyat:planla": Kapsam.KENDI_KAYDIM,
        "ameliyat:goruntule": Kapsam.KENDI_KAYDIM,
    ...
    Rol.HEMSIRE: {
        ...
        "hasta:goruntule": Kapsam.DEPARTMANIM,
        "hasta:guncelle": Kapsam.DEPARTMANIM,
        "tetkik:goruntule": Kapsam.DEPARTMANIM,
        "radyoloji:goruntule": Kapsam.DEPARTMANIM,
        "epikriz:goruntule": Kapsam.GLOBAL,
        "epikriz:olustur": Kapsam.GLOBAL,
        "epikriz:guncelle": Kapsam.GLOBAL,
        "nobet:goruntule": Kapsam.KENDI_KAYDIM,
    ...
    Rol.RADYOLOG: {
        "departman:goruntule": Kapsam.GLOBAL,
        "radyoloji:sonuc_gir": Kapsam.KENDI_KAYDIM,
        "radyoloji:goruntule": Kapsam.KENDI_KAYDIM,
        "nobet:goruntule": Kapsam.KENDI_KAYDIM,
        "sikayet_oneri:gonder": Kapsam.GLOBAL,
    },
